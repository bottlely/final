	...
	<form name="infoSetting" action="infoSetting.do" method="post">
		<table>
			...
			<tr>
				<th>Gender</th>
				<td>
					<input type="checkbox" name="gender_info" value="Man">Man
			...
			<tr>
				...
				<td>
					...
					<input type="text" name="birth_m"> - 
					<input type="text" name="birth_d">
				</td>
			</tr>
			<tr>
				<th>Tel</th>
		...
		<table>
			...
			<tr>
				<th>Favor</th>
				<td>
					<input type="checkbox" name="favor_info" value="movie">Movie
