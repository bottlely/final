...
<body>
   ...
   <div id="more3" style="background:white;height:20%;width:20%; position: absolute; float: right; display: none; z-index: 6; margin-top: 10%; margin-left: 10%">
	...
	<div id="galleryModal" class="modal fade" tabindex="-1" role="dialog"
		aria-hidden="true"
		style="margin: 3%; background: #f4f4f4; border: solid;">
		<section>
				...
				<div class="row">
						...
						<div id="myCarousel" class="carousel slide" data-ride="carousel">
							...
							<div class="carousel-inner">
								<div class="item active">
									<img src="img/14.jpg" alt="Los Angeles">
								</div>
					...
					<div class="col-xs-5"
						...
						<div class="col-sm-12" id="cntInfoBar">
							<span class="avatar"> <img src="img/profile.png" alt=""
								id="pf" />
							</span> <label id="name">작성자</label> <select name="coverage"
								onchange="hi(this)">
							...
							</select> <span> <input type="button" class="btn btn-primary"
								value="X">
							</span>
						...
						<div class="col-sm-12" id="cntInfoBar">
							<div class="col-sm-12" id="reply1">
								<span class="avatar"> <img src="img/profile.png" alt=""
									id="pf2" />
								</span> <label>사용자1</label> <span>댓글 내용1</span>
							</div>
							<div class="col-sm-12" id="reply1">
								<span class="avatar"> <img src="img/profile.png" alt=""
									id="pf2" />
								</span> <label>사용자2</label> <span>댓글 내용2</span>
							</div>
							<div class="col-sm-12" id="reply1">
								<span class="avatar"> <img src="img/profile.png" alt=""
									id="pf2" />
								</span> <label>사용자3</label> <span>댓글 내용3</span>
							</div>
						</div>

						<div class="col-sm-12">
							<div class="input-group">
								<input id="msg" type="text" class="form-control" name="reply"
									placeholder="댓글 입력"> <span class="input-group-addon"
									onclick="addReply()">작성</span>
							</div>
						</div>
					</div>
				</div>
